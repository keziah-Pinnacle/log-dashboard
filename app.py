    ...
    if not all_data:
        ...
        if filtered_df['battery'].notna().any():
            ...
            if not valid_df.empty:
                ...
                # Interpolate gaps >5 min (30-min for speed)
                ...
                fig.update_xaxes(title_text="Time (HH:MM)", tickformat="%H:%M", dtick="3600000", tickangle=45)  # 1 hour in ms
